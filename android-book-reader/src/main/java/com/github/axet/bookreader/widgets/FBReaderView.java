...
public class FBReaderView extends RelativeLayout {
    ...
    public void create() {
        ...
        app.ViewOptions.BottomMargin.setValue(app.ViewOptions.BottomMargin.getValue() * 8);
        app.ViewOptions.TopMargin.setValue(app.ViewOptions.BottomMargin.getValue());

        if( app.ViewOptions.LeftMargin.getValue() < 50 ) {
            app.ViewOptions.LeftMargin.setValue(app.ViewOptions.LeftMargin.getValue() * 1);
            app.ViewOptions.RightMargin.setValue(app.ViewOptions.RightMargin.getValue() * 1);
        } else {
            app.ViewOptions.LeftMargin.setValue(app.ViewOptions.LeftMargin.getValue() * 4);
            app.ViewOptions.RightMargin.setValue(app.ViewOptions.RightMargin.getValue() * 4);
        }
